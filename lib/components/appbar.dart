    ...
    child: Drawer(
      child: ListView(
        ...
        children: [
          ...
          createDrawerBodyItem(icon: Icons.shopping_cart, text: "Cart Items", onTap: () => Navigator.pushNamed(context, CartScreen.routeName)),
          createDrawerBodyItem(icon: Icons.logout, text: "Logout", onTap: () => _signout()),
        ],
      ),
    ),
  );
